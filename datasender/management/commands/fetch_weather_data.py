...
from datasender.utils import process_dataset  # Adjust this if necessary
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        datasets = ['Tmax', 'Tmin', 'Tmean', 'Rainfall', 'Sunshine', 'Raindays1mm', 'AirFrost']
        for dataset in datasets:
            ...
            try:
                ...
                self.stdout.write(self.style.ERROR(f'Failed to process dataset: {dataset}'))
